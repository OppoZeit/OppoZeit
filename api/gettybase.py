...
# This has been grabbed from https://github.com/tryolabs/python-simple-getty
...
class Session:
    ...
    def buy(self, image_id, size=__MAX_SIZE):
        ...
        request_headers = {'Token': self.__secure_token,
                           'CoordinationId': None}
        request_body = {'ImageSizes': [{'ImageId': image_id,
                                        'SizeKey': sizekey}]}
        ...
        request_headers = {'Token': self.__secure_token,
                           'CoordinationId': None}
        request_body = {"DownloadItems": [{'DownloadToken': download_token}]}
        payload = {'RequestHeader': request_headers,
